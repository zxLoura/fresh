...
* @Last Modified by:   ZX
* @Last Modified time: 2018-10-28 20:02:54
*/
window.onload=function(){
	...
	button[1].onclick=function(){
		if(input[0].value=="18435182023" && input[1].value=="123456"){
			button[1].style.background="#fbbc15";
			discover[0].style.display="block";
			discover[1].style.display="block";
        ...
        }else if(input[0].value=="18435182023" && input[1].value!="123456" || input[1].value!=""){
        	user[1].style.display="block";
        }
